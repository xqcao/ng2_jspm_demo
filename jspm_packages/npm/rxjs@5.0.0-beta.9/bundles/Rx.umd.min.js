    ...
    return function a(b, f, h) {
      ...
      1: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          g.prototype._subscribe = function(d) {
            return this.hasCompleted && this.hasNext ? (d.next(this.value), d.complete(), k.Subscription.EMPTY) : this.hasError ? (d.error(this.thrownError), k.Subscription.EMPTY) : a.prototype._subscribe.call(this, d);
          };
        ...
        a = function(a) {
          ...
          c.prototype._trimBufferThenGetEvents = function() {
            for (var a = this._getNow(),
                ...
                b = this._events,
                g = b.length,
                f = 0; f < g && !(a - b[f].time < d); )
              f++;
            g > c && (f = Math.max(f, g - c));
            0 < f && b.splice(0, f);
            return b;
          };
          return c;
      ...
      13: [function(a, b, f) {
        ...
        var d = function(a) {
          function e(e, d, b, g) {
            ...
            var f;
            e = this;
            k.isFunction(d) ? f = d : d && (e = d, f = d.next, b = d.error, g = d.complete, k.isFunction(e.unsubscribe) && this.add(e.unsubscribe.bind(e)), e.unsubscribe = this.unsubscribe.bind(this));
            this._context = e;
            this._next = f;
            this._error = b;
            this._complete = g;
          ...
          a.prototype.unsubscribe = function() {
            ...
            if (!this.isUnsubscribed) {
              ...
              if (h.isArray(f))
                for (var b = -1,
                    v = f.length; ++b < v; )
                  p = f[b], k.isObject(p) && (p = g.tryCatch(p.unsubscribe).call(p), p === d.errorObject && (a = !0, e = e || [], p = d.errorObject.e, p instanceof c.UnsubscriptionError ? e = e.concat(p.errors) : e.push(p)));
              if (a)
      ...
      141: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          d.create = function(a, e, m, b) {
            var g = a.length;
            return 0 === g ? new l.EmptyObservable : 1 !== g || e ? new d(a, e, m, b) : new k.ScalarObservable(a[0], b);
          };
      ...
      142: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          c.of = function() {
            ...
            var b = a.length;
            return 1 < b ? new c(a, d) : 1 === b ? new k.ScalarObservable(a[0], d) : new l.EmptyObservable(d);
          };
      ...
      143: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          m.prototype._subscribe = function(a) {
            ...
            l || (l = this.subject = new c.AsyncSubject, f = function u() {
              for (var a = [],
            ...
            }, f.source = this, g.tryCatch(e).apply(this, b.concat(f)) === d.errorObject && l.error(d.errorObject.e));
          ...
          m.dispatch = function(a) {
            ...
            var b = m.callbackFunc,
                ...
                u = m.subject;
            if (!u) {
              var u = m.subject = new c.AsyncSubject,
                  x = function y() {
                    for (var a = [],
                        c = 0; c < arguments.length; c++)
                      a[c - 0] = arguments[c];
                    var m = y.source,
                        c = m.selector,
                        m = m.subject;
                    c ? (a = g.tryCatch(c).apply(this, a), a === d.errorObject ? e.add(l.schedule(k, 0, {
                      err: d.errorObject.e,
                      subject: m
                    })) : e.add(l.schedule(h, 0, {
                      value: a,
                      subject: m
                    }))) : e.add(l.schedule(h, 0, {
              ...
              x.source = m;
              g.tryCatch(b).apply(this, f.concat(x)) === d.errorObject && u.error(d.errorObject.e);
            }
            e.add(u.subscribe(a));
          };
          return m;
      ...
      144: [function(a, b, f) {
        function h(a) {
          ...
          if (!r) {
            var r = g.subject = new e.AsyncSubject,
                u = function E() {
                  ...
                  var m = E.source,
                      ...
                      m = m.subject,
                      g = a.shift();
                  g ? m.error(g) : e ? (a = d.tryCatch(e).apply(this, a), a === c.errorObject ? b.add(v.schedule(l, 0, {
                    err: c.errorObject.e,
                    subject: m
                  })) : b.add(v.schedule(k, 0, {
                    value: a,
                    subject: m
                  }))) : b.add(v.schedule(k, 0, {
                    value: 1 === a.length ? a[0] : a,
            ...
            u.source = g;
            d.tryCatch(f).apply(this, h.concat(u)) === c.errorObject && r.error(c.errorObject.e);
          }
          b.add(r.subscribe(a));
        }
        function k(a) {
        ...
        a = function(a) {
          ...
          b.prototype._subscribe = function(a) {
            ...
            n || (n = this.subject = new e.AsyncSubject, g = function x() {
              for (var a = [],
                  e = 0; e < arguments.length; e++)
                a[e - 0] = arguments[e];
              var m = x.source,
      ...
      149: [function(a, b, f) {
        ...
        b = function(a) {
          ...
          e.create = function() {
            ...
            return 0 === a.length ? new k.EmptyObservable : new e(a, c);
          };
          e.prototype._subscribe = function(a) {
        ...
        a = function(a) {
          ...
          c.setupSubscription = function(a, d, b, f) {
            ...
            if (a && "[object NodeList]" === a.toString() || a && "[object HTMLCollection]" === a.toString())
              for (var k = 0,
                  h = a.length; k < h; k++)
                c.setupSubscription(a[k], d, b, f);
            else
              a && "function" === typeof a.addEventListener && "function" === typeof a.removeEventListener ? (a.addEventListener(d, b), l = function() {
          ...
          c.prototype._subscribe = function(a) {
            ...
            c.setupSubscription(this.sourceObj, this.eventName, d ? function() {
              ...
              c === l.errorObject ? a.error(l.errorObject.e) : a.next(c);
            } : function(c) {
              return a.next(c);
            }, a);
          };
      ...
      152: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.create = function(a, f, h, p) {
            var r = null,
                A = null;
            l.isFunction(f) ? (r = p || null, A = f) : d.isScheduler(r) && (r = f);
            if (null != a) {
              ...
              if (a && "number" === typeof a.length)
                return new n.ArrayLikeObservable(a, A, h, r);
            }
          ...
          b.prototype._subscribe = function(a) {
            var c = this.ish,
                e = this.scheduler;
            return null == e ? c[v]().subscribe(a) : c[v]().subscribe(new p.ObserveOnSubscriber(a, e, 0));
          };
          return b;
        }(t.Observable);
        f.FromObservable = a;
      ...
      153: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          d.create = function(a, e, m, b, g) {
            return 1 == arguments.length ? new d(a.initialState, a.condition, a.iterate, a.resultSelector || l, a.scheduler) : void 0 === b || k.isScheduler(b) ? new d(a, e, m, l, b) : new d(a, e, m, b, g);
          };
          d.prototype._subscribe = function(a) {
        ...
        var l = function(a) {
          ...
          d.prototype.tryIf = function() {
            var a = this.condition,
                ...
                b;
            try {
              (a = (b = a()) ? e : d) ? this.add(k.subscribeToResult(this, a)) : this._complete();
            } catch (g) {
              this._error(g);
            }
          };
        ...
        a = function(a) {
          function d(c, e) {
            ...
            if (!k.isNumeric(c) || 0 > c)
              this.period = 0;
            e && "function" === typeof e.schedule || (this.scheduler = l.async);
          }
          h(d, a);
              ...
              function a(c, e, d) {
                ...
                if (void 0 === d)
                  if (d = +c.length, isNaN(d))
                    d = 0;
                  else if (0 !== d && "number" === typeof d && k.root.isFinite(d)) {
                    var m;
                    m = +d;
      ...
      162: [function(a, b, f) {
        ...
        a = function(a) {
          function d(c, e, d) {
            ...
            this.delayTime = e;
            this.scheduler = d;
            if (!l.isNumeric(e) || 0 > e)
              this.delayTime = 0;
            d && "function" === typeof d.schedule || (this.scheduler = k.asap);
          }
          h(d, a);
      ...
      167: [function(a, b, f) {
        ...
        f.combineLatest = function() {
          ...
          return (new l.ArrayObservable(a, e)).lift(new g.CombineLatestOperator(c));
        };
      }, {
        "../operator/combineLatest": 200,
        "../util/isArray": 322,
      ...
      170: [function(a, b, f) {
        function h() {
          var a = new n.root.XMLHttpRequest;
          if (this.crossDomain) {
            if ("withCredentials" in a)
              return a.withCredentials = !0, a;
            if (n.root.XDomainRequest)
              return new n.root.XDomainRequest;
        ...
        var v = function(a) {
          function c(e, d) {
            ...
            "Content-Type" in b || (b["Content-Type"] = "application/x-www-form-urlencoded; charset=UTF-8");
          ...
          c.prototype.next = function(a) {
            ...
            var c = this.resultSelector,
                e = this.destination;
            a = new r(a, this.xhr, this.request);
            c ? (c = q.tryCatch(c)(a), c === t.errorObject ? this.error(t.errorObject.e) : e.next(c)) : e.next(a);
          };
          c.prototype.send = function() {
            var a = this.request,
                ...
                n = c.headers,
                c = c.body,
                f = q.tryCatch(a.createXHR).call(a);
            f === t.errorObject ? this.error(t.errorObject.e) : (this.xhr = f, (e ? q.tryCatch(f.open).call(f, d, b, m, e, g) : q.tryCatch(f.open).call(f, d, b, m)) === t.errorObject ? this.error(t.errorObject.e) : (f.timeout = a.timeout, f.responseType = a.responseType, this.setHeaders(f, n), this.setupEvents(f, a), c ? f.send(c) : f.send()));
          };
          c.prototype.serializeBody = function(a, c) {
            if (!a || "string" === typeof a || n.root.FormData && a instanceof n.root.FormData)
              return a;
            var e = c.indexOf(";");
          ...
          c.prototype.setupEvents = function(a, c) {
            ...
            a.ontimeout = function C(a) {
              var c = C.subscriber,
                  ...
                  d = C.request;
              e && e.error(a);
              c.error(new x(this, d));
            };
            a.ontimeout.request = c;
            a.ontimeout.subscriber = this;
            a.ontimeout.progressSubscriber = e;
            a.upload && "withCredentials" in a && n.root.XDomainRequest && (e && (a.onprogress = function w(a) {
              ...
              var c = w.progressSubscriber,
                  ...
                  d = w.request;
              c && c.error(a);
              e.error(new u("ajax error", this, d));
            ...
            a.onreadystatechange = function w(a) {
              ...
              if (4 === this.readyState) {
                ...
                0 === b && (b = m ? 200 : 0);
                200 <= b && 300 > b ? (e && e.complete(), c.next(a), c.complete()) : (e && e.error(a), c.error(new u("ajax error " + b, this, d)));
              }
            };
      ...
      171: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.prototype._connectSocket = function() {
            var a = this,
                c = this.protocol ? new WebSocket(this.url, this.protocol) : new WebSocket(this.url);
            this.socket = c;
            var b = new d.Subscription(function() {
              a.socket = null;
              c && 1 === c.readyState && c.close();
            }),
                g = this._output;
            c.onopen = function(d) {
              var m = a.openObserver;
              m && m.next(d);
              d = a.destination;
              a.destination = l.Subscriber.create(function(a) {
                ...
                b && b.next(void 0);
                d && d.code ? c.close(d.code, d.reason) : g.error(new TypeError("WebSocketSubject.error must be called with an object with an error code, and an optional reason: { code: number, reason: string }"));
              ...
              d && d instanceof e.ReplaySubject && b.add(d.subscribe(a.destination));
            };
            ...
            c.onclose = function(c) {
              ...
              e && e.next(c);
              c.wasClean ? g.complete() : g.error(c);
            };
            c.onmessage = function(c) {
              c = m.tryCatch(a.resultSelector)(c);
              c === n.errorObject ? g.error(n.errorObject.e) : g.next(c);
            };
          };
          b.prototype._subscribe = function(a) {
            var c = this;
            this.socket || this._connectSocket();
            var e = new d.Subscription;
          ...
          b.prototype.unsubscribe = function() {
            var c = this.socket;
            c && 1 === c.readyState && (c.close(), this.socket = null);
            a.prototype.unsubscribe.call(this);
            this.destination = new e.ReplaySubject;
          };
          return b;
      ...
      191: [function(a, b, f) {
        ...
        var k = this && this.__extends || function(a, e) {
          function d() {
            this.constructor = a;
          }
          for (var b in e)
          ...
          return a;
            ...
            g = function(a) {
              function c(c, b) {
                a.call(this, c);
                this.buffer = [];
                this.add(k.subscribeToResult(this, b));
              }
              h(c, a);
              c.prototype._next = function(a) {
                this.buffer.push(a);
      ...
      194: [function(a, b, f) {
        function h(a) {
          ...
          c.isUnsubscribed || (a.context.closeAction = this.schedule(a, a.bufferTimeSpan));
        }
        function k(a) {
          var c = a.bufferCreationInterval,
              ...
              b = a.scheduler,
              m = d.openContext();
          d.isUnsubscribed || (d.add(m.closeAction = b.schedule(l, e, {
            subscriber: d,
            context: m
          })), this.schedule(a, c));
        }
            ...
            n = function(a) {
              function c(e, d, b, m, g) {
                ...
                (this.timespanOnly = null == b || 0 > b) ? this.add(e.closeAction = g.schedule(h, d, {
                  ...
                  subscriber: this,
                  scheduler: g
                }, this.add(e.closeAction = g.schedule(l, d, {
                  subscriber: this,
                  context: e
          ...
          return a;
            ...
            d = function(a) {
              function e(e, d, b) {
                ...
                this.contexts = [];
                this.add(l.subscribeToResult(this, d));
              }
              h(e, a);
              e.prototype._next = function(a) {
                for (var c = this.contexts,
              ...
              e.prototype.trySubscribe = function(a) {
                var c = this.contexts,
                    e = new k.Subscription,
                    d = {
                      buffer: [],
                      subscription: e
                    };
                c.push(d);
                a = l.subscribeToResult(this, a, d);
          ...
          return a;
            ...
            e = function(a) {
              ...
              c.prototype.openBuffer = function() {
                ...
                c === g.errorObject ? this.error(g.errorObject.e) : (this.closingSubscription = a = new k.Subscription, this.add(a), this.subscribing = !0, a.add(d.subscribeToResult(this, c)), this.subscribing = !1);
              };
              return c;
            }(b.OuterSubscriber);
      }, {
      ...
      197: [function(a, b, f) {
        ...
        f.cache = function(a, b, d) {
          ...
          var c,
              ...
              f,
              q = function() {
                return c = new k.ReplaySubject(a, b, d);
              };
      ...
      198: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new l(a, this.selector, this.caught));
          };
          return a;
        }(),
            l = function(a) {
      ...
      201: [function(a, b, f) {
        function h() {
          ...
          return (new l.ArrayObservable(a, c)).lift(new g.MergeAllOperator(1));
        }
        var k = a("../util/isScheduler"),
      ...
      209: [function(a, b, f) {
        ...
        f.delay = function(a, c) {
          void 0 === c && (c = k.async);
          var e = l.isDate(a) ? +a - c.now() : Math.abs(a);
          ...
          return a;
            ...
            g = function(a) {
              function c(c, b, g) {
                ...
                g && this.add(k.subscribeToResult(this, g));
              }
              h(c, a);
              c.prototype.notifyNext = function(a, c, d, b, g) {
          ...
          return a;
            ...
            d = function(a) {
              ...
              e.prototype._next = function(a) {
                ...
                var e = !1;
                if (this.hasKey) {
                  if (e = k.tryCatch(this.compare)(this.key, c), e === l.errorObject)
                    return this.destination.error(l.errorObject.e);
                } else
                  this.hasKey = !0;
      ...
      218: [function(a, b, f) {
        ...
        f.every = function(a, d) {
          return this.lift(new k(a, d, this));
        };
        var k = function() {
          function a(d, c, e) {
            this.predicate = d;
            ...
            g = function(a) {
              ...
              c.prototype.tryNext = function(a) {
                ...
                try {
                  ...
                  this.add(k.subscribeToResult(this, b, a, c));
                } catch (g) {
                  d.error(g);
                }
              };
          ...
          c.prototype._next = function(a) {
            ...
            if (e.isUnsubscribed)
              ...
              if (this.active < this.concurrent) {
                e.next(a);
                var b = k.tryCatch(this.project)(a, d);
                b === l.errorObject ? e.error(l.errorObject.e) : this.scheduler ? this.add(this.scheduler.schedule(c.dispatch, 0, {
                  subscriber: this,
                  result: b,
                  value: a,
                  index: d
      ...
      224: [function(a, b, f) {
        ...
        f.find = function(a, d) {
          ...
          return this.lift(new k(a, this, !1, d));
        };
        var k = function() {
          function a(d, c, e, b) {
            this.predicate = d;
      ...
      226: [function(a, b, f) {
        ...
        f.first = function(a, c, e) {
          return this.lift(new l(a, c, e, this));
        };
        var l = function() {
          function a(c, e, d, b) {
            this.predicate = c;
        ...
        var l = function() {
          ...
          return a;
            ...
            g = function(a) {
              ...
              c.prototype._error = function(a) {
                var c = this.destination;
                c.next(k.Notification.createError(a));
                c.complete();
              };
              c.prototype._complete = function() {
                var a = this.destination;
      ...
      236: [function(a, b, f) {
        function h() {
          ...
          return 1 === a.length ? a[0] : (new k.ArrayObservable(a, e)).lift(new l.MergeAllOperator(c));
        }
      ...
      238: [function(a, b, f) {
        ...
        var g = function(a) {
          ...
          c.prototype._innerSub = function(a, c, d) {
            this.add(k.subscribeToResult(this, a, c, d));
          };
          c.prototype._complete = function() {
            this.hasCompleted = !0;
            0 === this.active && 0 === this.buffer.length && this.destination.complete();
          ...
          c.prototype._next = function(a) {
            if (this.active < this.concurrent) {
              var c = this.resultSelector,
                  ...
                  f = this.destination;
              this.active++;
              this._innerSub(b, f, c, a, d);
            } else
              this.buffer.push(a);
          };
          c.prototype._innerSub = function(a, c, d, b, f) {
      ...
      240: [function(a, b, f) {
        ...
        var c = function(a) {
          ...
          c.prototype._next = function(a) {
            if (this.active < this.concurrent) {
              var c = this.index++,
                  e = k.tryCatch(this.project)(this.acc, a),
                  d = this.destination;
              e === l.errorObject ? d.error(l.errorObject.e) : (this.active++, this._innerSub(e, a, c));
            } else
              this.buffer.push(a);
          };
      ...
      242: [function(a, b, f) {
        ...
        f.multicast = function(a, b) {
          var d = new k.ConnectableObservable(this, "function" === typeof a ? a : function() {
            return a;
          });
          return b ? new h.MulticastObservable(this, d, b) : d;
        };
      }, {
        "../observable/ConnectableObservable": 145,
        "../observable/MulticastObservable": 157
      ...
      244: [function(a, b, f) {
        ...
        f.onErrorResumeNextStatic = function() {
          ...
          1 === a.length && l.isArray(a[0]) && (a = a[0]);
          c = a.shift();
          return (new k.FromObservable(c, null)).lift(new d(a));
        };
        var d = function() {
          function a(c) {
            this.nextSources = c;
      ...
      251: [function(a, b, f) {
        ...
        f.publishReplay = function(a, b, d) {
          void 0 === a && (a = Number.POSITIVE_INFINITY);
          void 0 === b && (b = Number.POSITIVE_INFINITY);
          return k.multicast.call(this, new h.ReplaySubject(a, b, d));
        };
      }, {
        "../ReplaySubject": 9,
        "./multicast": 242
      ...
      265: [function(a, b, f) {
        ...
        f.startWith = function() {
          ...
          var f = a.length;
          return 1 === f ? g.concatStatic(new k.ScalarObservable(a[0], b), this) : 1 < f ? g.concatStatic(new h.ArrayObservable(a, b), this) : g.concatStatic(new l.EmptyObservable(b), this);
        };
      }, {
        "../observable/ArrayObservable": 142,
        "../observable/EmptyObservable": 147,
          ...
          return a;
            ...
            g = function(a) {
              ...
              c.prototype._innerSub = function(a, c, b) {
                ...
                d && d.unsubscribe();
                this.add(this.innerSubscription = k.subscribeToResult(this, a, c, b));
              };
              c.prototype._complete = function() {
      ...
      282: [function(a, b, f) {
        ...
        var g = function() {
          ...
          a.prototype.call = function(a, c) {
            var b = new d(a),
                f = c._subscribe(b);
            f.isUnsubscribed || b.add(l.subscribeToResult(b, this.windowBoundaries));
            return f;
          };
          return a;
        }(),
            ...
            g = function(a) {
              ...
              c.prototype._next = function(a) {
                for (var c = 0 < this.startWindowEvery ? this.startWindowEvery : this.windowSize,
                    ...
                    f = this.windows,
                    g = f.length,
                    h = 0; h < g && !this.isUnsubscribed; h++)
                  f[h].next(a);
                a = this.count - d + 1;
                0 <= a && 0 === a % c && !this.isUnsubscribed && f.shift().complete();
                0 !== ++this.count % c || this.isUnsubscribed || (c = new k.Subject, f.push(c), b.next(c));
              };
              c.prototype._error = function(a) {
                var c = this.windows;
                if (c)
      ...
      290: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.prototype._schedule = function(b, c) {
            ...
            e.actions.push(this);
            e.scheduledId || (e.scheduledId = k.AnimationFrame.requestAnimationFrame(function() {
              e.scheduledId = null;
              e.flush();
            }));
            return this;
          ...
          b.prototype._unsubscribe = function() {
            ...
            0 === e.length && (b.active = !1, null != c && (b.scheduledId = null, k.AnimationFrame.cancelAnimationFrame(c)));
          };
          return b;
        }(b.FutureAction);
      ...
      291: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.prototype.scheduleNow = function(a, c) {
            return (new k.AnimationFrameAction(this, a)).schedule(c);
          };
          return b;
        }(b.QueueScheduler);
      ...
      292: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.prototype._schedule = function(b, c) {
            ...
            var e = this.scheduler;
            e.actions.push(this);
            e.scheduledId || (e.scheduledId = k.Immediate.setImmediate(function() {
              e.scheduledId = null;
              e.flush();
            }));
            return this;
          ...
          b.prototype._unsubscribe = function() {
            var b = this.scheduler,
                ...
                e = b.actions;
            a.prototype._unsubscribe.call(this);
            0 === e.length && (b.active = !1, null != c && (b.scheduledId = null, k.Immediate.clearImmediate(c)));
          };
          return b;
      ...
      293: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          h(b, a);
          b.prototype.scheduleNow = function(a, c) {
            return (new k.AsapAction(this, a)).schedule(c);
          };
          return b;
      ...
      294: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          h(b, a);
          b.prototype.scheduleNow = function(a, c) {
            return (new k.FutureAction(this, a)).schedule(c, 0);
          };
          return b;
        }(a("./QueueScheduler").QueueScheduler);
        f.AsyncScheduler = a;
        ...
        a = function(a) {
          ...
          b.prototype._schedule = function(a, c) {
            ...
            this.id = k.root.setInterval(function() {
              ...
              c.actions.push(b);
              c.flush();
              !1 === b.pending && null != a && (b.id = null, k.root.clearInterval(a));
            }, c);
            return this;
          };
          b.prototype._unsubscribe = function() {
      ...
      297: [function(a, b, f) {
        ...
        a = function() {
          ...
          a.prototype.scheduleLater = function(a, b, c) {
            return (new k.FutureAction(this, a)).schedule(c, b);
          };
          return a;
        }();
        f.QueueScheduler = a;
      ...
      298: [function(a, b, f) {
        ...
        b = function() {
          ...
          a.prototype.schedule = function(a, b, c) {
            void 0 === b && (b = 0);
            this.sorted = !1;
            return (new k(this, a, this.index++)).schedule(c, b);
          };
        ...
        a = function(a) {
          ...
          b.prototype.expectObservable = function(a, c) {
            ...
            this.schedule(function() {
              h = a.subscribe(function(a) {
                var c = a;
                a instanceof k.Observable && (c = d.materializeInnerObservable(c, d.frame));
                e.push({
                  frame: d.frame,
                  notification: l.Notification.createNext(c)
                });
              }, function(a) {
                e.push({
                  frame: d.frame,
          ...
          b.parseMarbles = function(a, c, b, d) {
            ...
            for (var e = a.length,
                ...
                m = -1,
                y = 0; y < e; y++) {
              var D = y * this.frameTimeFactor + h,
                  z = void 0,
                  A = a[y];
              switch (A) {
                case "-":
                ...
                case "^":
                  break;
                case "#":
                  z = l.Notification.createError(b || "error");
                  break;
                default:
                  z = l.Notification.createNext(k(A));
              }
              z && f.push({
                frame: -1 < m ? m : D,
                notification: z
            ...
            if (k.isArray(b)) {
              ...
              if ("function" === typeof b[d.$$iterator]) {
                for (a = 0; a < b.length && (p.next(b[a]), !p.isUnsubscribed); a++)
                  ;
                p.isUnsubscribed || p.complete();
              } else if ("function" === typeof b[e])
                if (b = b[e](), "function" !== typeof b.subscribe)
